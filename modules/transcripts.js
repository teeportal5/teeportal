    ...
    try {
        ...
        data.courses.forEach((course, courseIndex) => {
            if (course.assessments && course.assessments.length > 0) {
                ...
                doc.setTextColor(102, 102, 102);
                let gradeColor = '';
                if (course.finalGrade === 'DISTINCTION') gradeColor = 'green';
                else if (course.finalGrade === 'CREDIT') gradeColor = 'blue';
                else if (course.finalGrade === 'PASS') gradeColor = 'orange';
                else if (course.finalGrade === 'FAIL') gradeColor = 'red';
